...
*/
		...
		*/
		...
		//  htblColNameRange.put("major", "cs");
		  ...
		  Hashtable<String, String> delete = new Hashtable<String,
				  String>();	  
		 delete.put("age", "3");
		 delete.put("ID", "2810999");
		 deleteFromTable("testvalueRange", delete, "OR");
		 
		  I = selectRangeFromTableV2("testvalueRange",
				  htblColNameRange, "OR");
				  while (I.hasNext()) { System.out.println("AFTER " +
				  I.next().toString()); }
